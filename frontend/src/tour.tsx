...
const TOURS: Record<"student" | "instructor", Step[]> = {
  student: [
    ...
    { go: "workshop", title: "The Workshop",
      text: "Gather with your starred specialty for triple yield, and craft goods worth more than their parts. Later you'll build facilities that work while you sleep. Fixed costs, dear student. Mind your effort bar up top: twenty fresh at dawn, forty at most, and the rest evaporates." },
    ...
    { go: "study", title: "The Study",
      text: "My favorite room. Every idea from the course sits here with a meter showing how well you've shown it to me, and you can practice any of them — some with charts to read. Your first correct answer each day earns effort, and this mastery is where your grade comes from." },
    { go: "boards", title: "Leaderboards and your grade",
      text: "Wealth buys bragging rights, not grades. Your grade comes from playing and from what the Study says you understand. I'll bring you one question a day myself; tap my portrait anytime for more. Now go trade something." },
  ],
  instructor: [
    ...
    { go: "heatmap", title: "Mastery",
      text: "Every learning objective for every student, measured by in-game tutor checks. Green is mastered; red is what to cover in your next lecture. Students see their own row in Pip's Study and can practice weak objectives directly, including diagram-reading questions." },
